...
export default function SupremeCourtExplorer() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error("Supreme Court API not implemented");
      }
      ...
      setError(
        "Supreme Court judgment module is currently under development. Please explore IPC Assistant or Crime Analytics modules."
      );
    } finally {
      setLoading(false);
    }
